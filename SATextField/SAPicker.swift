...
class SAPicker: NSObject {
    
    private static let sharedInstance = SAPicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          dataArray:Array<String> = [],
                          selectedIndex: Int? = nil,
                          type: SAPickerType = .date,
                          style: RDatePickerStyle = .Wheel) -> RPickerController? {
        
        
        if let cc = UIWindow.currentController {
            if SAPicker.sharedInstance.isPresented == false {
                SAPicker.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    SAPicker.sharedInstance.isPresented = false
                }
...
class RPickerController: UIViewController {
    ...
    var pickerType: SAPickerType = .date
